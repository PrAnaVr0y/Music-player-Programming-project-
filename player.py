...
root = Tk()
root.title("Pranav's Music player")
...
Button(root, image=ButtonStop, bg="#FFFFFF", bd=0, height=60, width=60, command=StopMusic).place(x=130, y=487)

ButtonPause = PhotoImage(file="pause.png")
Button(root, image=ButtonPause, bg="#FFFFFF", bd=0, height=60, width=60, command=PauseMusic).place(x=300, y=487)
